        ...
        <div class="col-lg-4">
            <div>
                ...
                <div class="course-sidbar">
                    ...
                    <div class="action">
                        <a href="#" data-url="{{ route('admin.courses.delete', [$course->id])}}" class="btn btn-danger delete-course">
            ...
            <div class="course-video">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center">
                        ...
                        <div class="ml-auto"><a href="{{ route('admin.courses.lectures.show', [$course->id])}}"><i class="fas fa-plus"></i>  {{__('Add Lectures')}} </a></div>
                    </div>
                    <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                          <select id="lang" name="languge" class="custom-select @error('languge') is-invalid @enderror">
                              ...
                              <option @if (old('languge')=='en' || $course->languge =='en' ) selected @endif value="en">{{__('English')}} </option>
                              <option @if (old('languge')=='ar' || $course->languge =='ar') selected @endif value="ar">{{__('Arabic')}} </option>
                          </select> 
                    </div>
                        @error('languge')
                            <p class="text-danger">{{ $message }}</p>
