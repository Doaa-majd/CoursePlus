      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 text-left">
            <p><i class="fa fa-graduation-cap"></i> {{__('Best learning management platform for ever.')}}  </p>
          </div>
          ...
          <div class="navbar navbar-default" role="navigation">
            ...
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                <li class="dropdown ttmenu-half"><a href="/"> {{ __('Home') }} </a>
                  
                </li>
                <li><a href="#"> {{ __('About') }}</a></li>
                <li class="dropdown ttmenu-half"><a href="#" data-toggle="dropdown" class="dropdown-toggle"> {{ __('Categories') }} <b
                ...
                <li>
                  ...
                  <form id="search-form" action="{{ route('search.index') }}" method="get">
                    ...
                    <a href="{{ route('search.index') }}" onclick="event.preventDefault();
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                  <a href="#" class="site_lang" data-url="{{ route('changelang.store')}}" data-lang="{{$dataLang}}"> {{ $textLang }} </a>
                </li>

                @auth
                <li><a href="{{ route('user.courses.index') }}">  {{ __('My Courses') }}</a></li>
                ...
                @endauth
                <li><a href="#"> <i class="fa fa-shopping-cart" style="font-size: 20px"></i></a></li>
